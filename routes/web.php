...
Route::group(['prefix' => 'admin'], function() {
    ...
    Route::get('profile/profile', 'Admin\ProfileController@add')->name('profile')->middleware('auth');
    Route::post('profile/profile', 'Admin\ProfileController@edit')->middleware('auth');
});
Auth::routes();
